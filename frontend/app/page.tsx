    ...
    <div className="min-h-screen flex flex-col w-full">
            ...
            {[
              {
                ...
                description: "Filter berdasarkan lokasi, harga, fasilitas, tipe, dan rating. Temukan kost идеаль sesuai kriteria dalam hitungan detik.",
      ...
      <footer className="relative w-full h-80">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#011E55] via-[#011E55]/95 to-transparent flex flex-col">
          <div className="max-w-6xl mx-auto px-6 py-16 w-full">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div className="md:col-span-2">
                <h3 className="text-3xl font-bold text-white mb-4">KOSE</h3>
